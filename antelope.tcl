...
proc create_notemenu {} {
     ...
     .notemenu add .notemenu.file -text "  File  " -underline 2 -padding 2
     ...
     .notemenu add .notemenu.options -text "  Options  " -underline 2 -padding 2

	 ## Populate account profile pane
	 ttk::frame .notemenu.profile
     .notemenu add .notemenu.profile -text "  Account Profile  " -underline 2 -padding 2

     ## Populate general market pane
	 ttk::frame .notemenu.market
     .notemenu add .notemenu.market -text "  General Market  " -underline 2 -padding 2

	 ## Populate stock category pane
	 ttk::frame .notemenu.category
     .notemenu add .notemenu.category -text "  Stock Category  " -underline 2 -padding 2

	 ## Populate short term pane
	 ttk::frame .notemenu.shortterm
     .notemenu add .notemenu.shortterm -text "  Short Term  " -underline 2 -padding 2

	 ## Populate commodity pane
	 ttk::frame .notemenu.commodity
     .notemenu add .notemenu.commodity -text "  Commodity  " -underline 2 -padding 2

	 ## Populate help pane
	 ttk::frame .notemenu.help
     .notemenu add .notemenu.help -text "  Help  " -underline 2 -padding 2
}
...
proc create_op_panel {} {
     ...
     $panels.charts add $panels.charts.daily -text " Daily " -underline 1 -padding 2 
     ...
     $panels.charts add $panels.charts.weekly -text " Weekly " -underline 1 -padding 2
     ...
     $panels.charts add $panels.charts.monthly -text " Monthly " -underline 1 -padding 2
